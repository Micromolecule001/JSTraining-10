...
function customObjectFromEntries(entries) {
  ...
  return Object.fromEntries(
    entries.map(entry => [entry[0], typeof entry[1] === "number" ? entry[1].toString() : entry[1]])
  );
...
function keysAndValues(obj) {
  ...
  result[0] = Object.keys(obj);
  result[1] = Object.values(obj);
...
function checkAndPreventExtensions(obj) {
  if (obj === Object || Object.isSealed(obj) == false ) {
    return false;
  }
...
function getObjectValuesSum(obj) {
  ...
  return Object.values(obj).reduce((accumulator, element) => accumulator += element, 0);
